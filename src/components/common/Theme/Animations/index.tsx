  ...
  <Global
    styles={[
      css`
        ...
        @keyframes showreel-appear-slight {
          0% {
            opacity: 0;
            transform: translate3d(0, 0, 0);
          }
        ...
        :root {
          ...
          --animation-marquee-slow: 20s linear marquee infinite;
          --animation-showreel-appear: 1s var(--cubic-easing) showreel-appear
            forwards;
          --animation-showreel-appear-slight: 1s var(--cubic-easing)
            showreel-appear-slight forwards;
        }
      `
    ]}
  />
